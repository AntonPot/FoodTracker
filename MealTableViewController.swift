...
class MealTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Fethces the appropriate meal for the data source layout
    ...
    */
    ...
    private func loadSampleMeals() -> Void {
        let photo1 = UIImage(named: "meal1")
        let photo2 = UIImage(named: "meal2")
        let photo3 = UIImage(named: "meal3")
        
        guard let meal1 = Meal(name: "Caprese Salad", rating: 4, photo: photo1 ) else {
            fatalError("Unable to initialize meal1")
        }
        guard let meal2 = Meal(name: "Chicken and Potatos", rating: 5, photo: photo2 ) else {
            fatalError("Unable to initialize meal2")
        }
        guard let meal3 = Meal(name: "Pasta with Meatballs", rating: 3, photo: photo3) else {
    ...
    private func saveMeals() {
        ...
        if isSuccessfulSave {
            os_log("Meals successfuly saved.", log: OSLog.default, type: OSLogType.debug)
        } else {
